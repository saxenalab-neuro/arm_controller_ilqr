#!/bin/sh
#SBATCH --job-name=armf_h
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=24:00:00
#SBATCH --array=1-8
#SBATCH --output=RSAC_f_h_%A-%a.out

# Purpose: generate recurrence-only fixation trajectories from the matching
...
# Run recurrence-only fixation for this array index.
"$python_bin" "$repo_root/ilqr_f_h.py" --final-theta "$repo_root/final_theta_traj.npy"
